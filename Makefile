...
TEST_SRC = internal/utils/utils.cx\
	internal/presentation/home-screen.cx\
	internal/domain/cell.cx\
	internal/domain/point.cx\
	internal/domain/board.cx\
	internal/domain/player.cx\
	internal/domain/game.cx

run:
	cx $(OPTS_MEM) $(SRC) $(TEST_SRC) cmd/main.cx ++data=$(DATA)
